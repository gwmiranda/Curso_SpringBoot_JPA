...
--
-- Name: tb_order fkb75i7jqu67db7mtwtymjohybr; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order
    ADD CONSTRAINT fkb75i7jqu67db7mtwtymjohybr FOREIGN KEY (client) REFERENCES public.tb_user(id);
